...
const ::google::protobuf::uint32 TableStruct::offsets[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  ...
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::TurtleToTurtle::T2TDatagram, agent_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::TurtleToTurtle::T2TDatagram, nodeversion_),
  ...
  ~0u,  // no _weak_field_map_
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::TurtleToTurtle::BlockChainPayload, blockchainid_),
...
static const ::google::protobuf::internal::MigrationSchema schemas[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 14, -1, sizeof(::TurtleToTurtle::T2TCandidateList)},
  { 20, -1, sizeof(::TurtleToTurtle::T2TCandidateListRequest)},
  { 26, -1, sizeof(::TurtleToTurtle::T2TCandidate)},
  { 38, -1, sizeof(::TurtleToTurtle::T2TNodeCapability)},
  { 45, -1, sizeof(::TurtleToTurtle::BlockChainPayload)},
};
...
const int T2TDatagram::kAgentFieldNumber;
const int T2TDatagram::kNodeVersionFieldNumber;
...
T2TDatagram::T2TDatagram(const T2TDatagram& from)
  ...
  if (from.agent().size() > 0) {
    agent_.AssignWithDefault(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), from.agent_);
  }
  nodeversion_.UnsafeSetDefault(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
  if (from.nodeversion().size() > 0) {
    nodeversion_.AssignWithDefault(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), from.nodeversion_);
  }
...
void T2TDatagram::SharedDtor() {
  ...
  nodeversion_.DestroyNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
  if (has_dataPayload()) {
    clear_dataPayload();
  }
}
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 4: {
        if (static_cast< ::google::protobuf::uint8>(tag) ==
          ...
          DO_(::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
            ...
            ::google::protobuf::internal::WireFormatLite::PARSE,
            "TurtleToTurtle.T2TDatagram.agent"));
        } else {
          goto handle_unusual;
        }
        break;
      ...
      case 5: {
        if (static_cast< ::google::protobuf::uint8>(tag) ==
          ...
          DO_(::google::protobuf::internal::WireFormatLite::ReadString(
                input, this->mutable_nodeversion()));
          DO_(::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
            this->nodeversion().data(), static_cast<int>(this->nodeversion().length()),
            ::google::protobuf::internal::WireFormatLite::PARSE,
            "TurtleToTurtle.T2TDatagram.nodeVersion"));
        } else {
          goto handle_unusual;
        }
        break;
...
void T2TDatagram::SerializeWithCachedSizes(
  ...
  // string nodeVersion = 5;
  if (this->nodeversion().size() > 0) {
    ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
      this->nodeversion().data(), static_cast<int>(this->nodeversion().length()),
      ::google::protobuf::internal::WireFormatLite::SERIALIZE,
      "TurtleToTurtle.T2TDatagram.nodeVersion");
    ::google::protobuf::internal::WireFormatLite::WriteStringMaybeAliased(
      5, this->nodeversion(), output);
  }

  // .TurtleToTurtle.T2TCandidateList t2tCandidateList = 6;
  if (has_t2tcandidatelist()) {
    ::google::protobuf::internal::WireFormatLite::WriteMessageMaybeToArray(
      6, this->_internal_t2tcandidatelist(), output);
  }

  // .TurtleToTurtle.T2TCandidateListRequest t2tCandidateListRequest = 7;
  if (has_t2tcandidatelistrequest()) {
    ::google::protobuf::internal::WireFormatLite::WriteMessageMaybeToArray(
      7, this->_internal_t2tcandidatelistrequest(), output);
  }

  // .TurtleToTurtle.BlockChainPayload blockChainPayload = 8;
  if (has_blockchainpayload()) {
    ::google::protobuf::internal::WireFormatLite::WriteMessageMaybeToArray(
      8, this->_internal_blockchainpayload(), output);
  }
...
::google::protobuf::uint8* T2TDatagram::InternalSerializeWithCachedSizesToArray(
  ...
  if (has_t2tcandidatelist()) {
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessageToArray(
        6, this->_internal_t2tcandidatelist(), deterministic, target);
  }
  ...
  if (has_t2tcandidatelistrequest()) {
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessageToArray(
        7, this->_internal_t2tcandidatelistrequest(), deterministic, target);
  }
  ...
  if (has_blockchainpayload()) {
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessageToArray(
        8, this->_internal_blockchainpayload(), deterministic, target);
  }
...
void T2TDatagram::InternalSwap(T2TDatagram* other) {
  ...
  agent_.Swap(&other->agent_, &::google::protobuf::internal::GetEmptyStringAlreadyInited(),
    GetArenaNoVirtual());
  nodeversion_.Swap(&other->nodeversion_, &::google::protobuf::internal::GetEmptyStringAlreadyInited(),
    GetArenaNoVirtual());
...
#if !defined(_MSC_VER) || _MSC_VER >= 1900
const int BlockChainPayload::kBlockChainIdFieldNumber;
...
void BlockChainPayload::SerializeWithCachedSizes(
  ...
  if (this->blockchainid() != 0) {
    ::google::protobuf::internal::WireFormatLite::WriteUInt32(1, this->blockchainid(), output);
  }
...
::google::protobuf::uint8* BlockChainPayload::InternalSerializeWithCachedSizesToArray(
  ...
  // uint32 blockChainId = 1;
  if (this->blockchainid() != 0) {
    target = ::google::protobuf::internal::WireFormatLite::WriteUInt32ToArray(1, this->blockchainid(), target);
  }
...
// @@protoc_insertion_point(class_specific_merge_from_start:TurtleToTurtle.BlockChainPayload)
  ...
  if (from.blockchainid() != 0) {
    set_blockchainid(from.blockchainid());
  }
  switch (from.data_case()) {
    case kBlock: {
      mutable_block()->::TurtleToTurtle::TurtleCoin::TurtleBlock::MergeFrom(from.block());
...
void BlockChainPayload::InternalSwap(BlockChainPayload* other) {
  using std::swap;
  swap(blockchainid_, other->blockchainid_);
