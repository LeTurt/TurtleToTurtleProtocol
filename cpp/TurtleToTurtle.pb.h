...
class T2TDatagram : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:TurtleToTurtle.T2TDatagram) */ {
 public:
  ...
  enum DataPayloadCase {
    kT2TCandidateList = 6,
    kT2TCandidateListRequest = 7,
    kBlockChainPayload = 8,
  ...
  void clear_nodeversion();
  static const int kNodeVersionFieldNumber = 5;
  const ::std::string& nodeversion() const;
  void set_nodeversion(const ::std::string& value);
  #if LANG_CXX11
  void set_nodeversion(::std::string&& value);
  #endif
  void set_nodeversion(const char* value);
  void set_nodeversion(const char* value, size_t size);
  ::std::string* mutable_nodeversion();
  ::std::string* release_nodeversion();
  void set_allocated_nodeversion(::std::string* nodeversion);
  ...
  // .TurtleToTurtle.T2TCandidateList t2tCandidateList = 6;
  bool has_t2tcandidatelist() const;
  void clear_t2tcandidatelist();
  static const int kT2TCandidateListFieldNumber = 6;
  private:
  ...
  // .TurtleToTurtle.T2TCandidateListRequest t2tCandidateListRequest = 7;
  bool has_t2tcandidatelistrequest() const;
  void clear_t2tcandidatelistrequest();
  static const int kT2TCandidateListRequestFieldNumber = 7;
  private:
  ...
  // .TurtleToTurtle.BlockChainPayload blockChainPayload = 8;
  bool has_blockchainpayload() const;
  void clear_blockchainpayload();
  static const int kBlockChainPayloadFieldNumber = 8;
  private:
 ...
 private:
  ...
  ::google::protobuf::internal::ArenaStringPtr nodeversion_;
...
class BlockChainPayload : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:TurtleToTurtle.BlockChainPayload) */ {
 public:
  ...
  void clear_blockchainid();
  static const int kBlockChainIdFieldNumber = 1;
  ::google::protobuf::uint32 blockchainid() const;
  void set_blockchainid(::google::protobuf::uint32 value);
 ...
 private:
  ...
  ::google::protobuf::internal::InternalMetadataWithArena _internal_metadata_;
  ::google::protobuf::uint32 blockchainid_;
  union DataUnion {
    DataUnion() {}
...
// string agent = 4;
inline void T2TDatagram::clear_agent() {
  agent_.ClearToEmptyNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline const ::std::string& T2TDatagram::agent() const {
  // @@protoc_insertion_point(field_get:TurtleToTurtle.T2TDatagram.agent)
  return agent_.GetNoArena();
}
inline void T2TDatagram::set_agent(const ::std::string& value) {
  
  agent_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:TurtleToTurtle.T2TDatagram.agent)
}
#if LANG_CXX11
inline void T2TDatagram::set_agent(::std::string&& value) {
  
  agent_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:TurtleToTurtle.T2TDatagram.agent)
}
#endif
inline void T2TDatagram::set_agent(const char* value) {
  GOOGLE_DCHECK(value != NULL);
  
  agent_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:TurtleToTurtle.T2TDatagram.agent)
}
inline void T2TDatagram::set_agent(const char* value, size_t size) {
  
  agent_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:TurtleToTurtle.T2TDatagram.agent)
}
inline ::std::string* T2TDatagram::mutable_agent() {
  
  // @@protoc_insertion_point(field_mutable:TurtleToTurtle.T2TDatagram.agent)
  return agent_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* T2TDatagram::release_agent() {
  // @@protoc_insertion_point(field_release:TurtleToTurtle.T2TDatagram.agent)
  
  return agent_.ReleaseNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline void T2TDatagram::set_allocated_agent(::std::string* agent) {
  if (agent != NULL) {
  ...
  // @@protoc_insertion_point(field_set_allocated:TurtleToTurtle.T2TDatagram.agent)
}

// string nodeVersion = 5;
inline void T2TDatagram::clear_nodeversion() {
  nodeversion_.ClearToEmptyNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline const ::std::string& T2TDatagram::nodeversion() const {
  // @@protoc_insertion_point(field_get:TurtleToTurtle.T2TDatagram.nodeVersion)
  return nodeversion_.GetNoArena();
}
inline void T2TDatagram::set_nodeversion(const ::std::string& value) {
  
  nodeversion_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:TurtleToTurtle.T2TDatagram.nodeVersion)
}
#if LANG_CXX11
inline void T2TDatagram::set_nodeversion(::std::string&& value) {
  
  nodeversion_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:TurtleToTurtle.T2TDatagram.nodeVersion)
}
#endif
inline void T2TDatagram::set_nodeversion(const char* value) {
  GOOGLE_DCHECK(value != NULL);
  
  nodeversion_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:TurtleToTurtle.T2TDatagram.nodeVersion)
}
inline void T2TDatagram::set_nodeversion(const char* value, size_t size) {
  
  nodeversion_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:TurtleToTurtle.T2TDatagram.nodeVersion)
}
inline ::std::string* T2TDatagram::mutable_nodeversion() {
  
  // @@protoc_insertion_point(field_mutable:TurtleToTurtle.T2TDatagram.nodeVersion)
  return nodeversion_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* T2TDatagram::release_nodeversion() {
  // @@protoc_insertion_point(field_release:TurtleToTurtle.T2TDatagram.nodeVersion)
  
  return nodeversion_.ReleaseNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline void T2TDatagram::set_allocated_nodeversion(::std::string* nodeversion) {
  if (nodeversion != NULL) {
    
  } else {
    
  }
  nodeversion_.SetAllocatedNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), nodeversion);
  // @@protoc_insertion_point(field_set_allocated:TurtleToTurtle.T2TDatagram.nodeVersion)
}
...
// uint32 blockChainId = 1;
inline void BlockChainPayload::clear_blockchainid() {
  blockchainid_ = 0u;
}
inline ::google::protobuf::uint32 BlockChainPayload::blockchainid() const {
  // @@protoc_insertion_point(field_get:TurtleToTurtle.BlockChainPayload.blockChainId)
  return blockchainid_;
}
inline void BlockChainPayload::set_blockchainid(::google::protobuf::uint32 value) {
  
  blockchainid_ = value;
  // @@protoc_insertion_point(field_set:TurtleToTurtle.BlockChainPayload.blockChainId)
}
