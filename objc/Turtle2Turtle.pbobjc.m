...
@implementation Turtle2TurtleRoot
...
#pragma mark - Turtle2TurtleRoot_FileDescriptor

static GPBFileDescriptor *Turtle2TurtleRoot_FileDescriptor(void) {
  ...
  if (!descriptor) {
    ...
    GPBDescriptor *localDescriptor =
        [GPBDescriptor allocDescriptorForClass:[T2TDatagram class]
                                     rootClass:[Turtle2TurtleRoot class]
                                          file:Turtle2TurtleRoot_FileDescriptor()
                                        fields:fields
