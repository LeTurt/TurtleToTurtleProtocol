 ...
 **/
@interface TurtleToTurtleRoot : GPBRootObject
@end
...
typedef GPB_ENUM(T2TDatagram_FieldNumber) {
  ...
  T2TDatagram_FieldNumber_Agent = 4,
  T2TDatagram_FieldNumber_NodeVersion = 5,
  T2TDatagram_FieldNumber_T2TCandidateList = 6,
  T2TDatagram_FieldNumber_T2TCandidateListRequest = 7,
  T2TDatagram_FieldNumber_BlockChainPayload = 8,
};

typedef GPB_ENUM(T2TDatagram_DataPayload_OneOfCase) {
  T2TDatagram_DataPayload_OneOfCase_GPBUnsetOneOfCase = 0,
  T2TDatagram_DataPayload_OneOfCase_T2TCandidateList = 6,
  T2TDatagram_DataPayload_OneOfCase_T2TCandidateListRequest = 7,
  T2TDatagram_DataPayload_OneOfCase_BlockChainPayload = 8,
};
...
@property(nonatomic, readwrite, copy, null_resettable) NSString *nodeVersion;
...
typedef GPB_ENUM(BlockChainPayload_FieldNumber) {
  BlockChainPayload_FieldNumber_BlockChainId = 1,
  BlockChainPayload_FieldNumber_Block = 2,
  BlockChainPayload_FieldNumber_Transaction = 3,
};

typedef GPB_ENUM(BlockChainPayload_Data_OneOfCase) {
  BlockChainPayload_Data_OneOfCase_GPBUnsetOneOfCase = 0,
  BlockChainPayload_Data_OneOfCase_Block = 2,
  BlockChainPayload_Data_OneOfCase_Transaction = 3,
};

@interface BlockChainPayload : GPBMessage

@property(nonatomic, readwrite) uint32_t blockChainId;
