  ...
  if (!descriptor) {
    static GPBMessageFieldDescription fields[] = {
      ...
      },
      {
        .name = "agent",
        .dataTypeSpecific.className = NULL,
        .number = T2TDatagram_FieldNumber_Agent,
        .hasIndex = 3,
        .offset = (uint32_t)offsetof(T2TDatagram__storage_, agent),
        .flags = GPBFieldOptional,
        .dataType = GPBDataTypeString,
      },
      {
        .name = "nodeVersion",
        .dataTypeSpecific.className = NULL,
        .number = T2TDatagram_FieldNumber_NodeVersion,
        .hasIndex = 4,
        .offset = (uint32_t)offsetof(T2TDatagram__storage_, nodeVersion),
        .flags = (GPBFieldFlags)(GPBFieldOptional | GPBFieldTextFormatNameCustom),
        .dataType = GPBDataTypeString,
      },
      {
    ...
    static const char *extraTextFormatInfo =
        "\006\001\002*\000\003\006\000\005\013\000\006\002.\000\007\0025\000\010\021\000";
    ...
    static GPBMessageFieldDescription fields[] = {
      {
        .name = "blockChainId",
        .dataTypeSpecific.className = NULL,
        .number = BlockChainPayload_FieldNumber_BlockChainId,
        .hasIndex = 0,
        .offset = (uint32_t)offsetof(BlockChainPayload__storage_, blockChainId),
        .flags = (GPBFieldFlags)(GPBFieldOptional | GPBFieldTextFormatNameCustom),
        .dataType = GPBDataTypeUInt32,
      },
      {
