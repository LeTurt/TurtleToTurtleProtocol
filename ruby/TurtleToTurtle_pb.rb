...
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_message "TurtleToTurtle.T2TDatagram" do
    ...
    oneof :dataPayload do
      optional :t2tCandidateList, :message, 4, "TurtleToTurtle.T2TCandidateList"
      optional :t2tCandidateListRequest, :message, 5, "TurtleToTurtle.T2TCandidateListRequest"
      optional :blockChainPayload, :message, 6, "TurtleToTurtle.BlockChainPayload"
    end
  end
  ...
  add_message "TurtleToTurtle.BlockChainPayload" do
    oneof :data do
      optional :block, :message, 1, "TurtleToTurtle.TurtleCoin.TurtleBlock"
      optional :transaction, :message, 2, "TurtleToTurtle.TurtleCoin.TurtleTransaction"
    end
  end
end
